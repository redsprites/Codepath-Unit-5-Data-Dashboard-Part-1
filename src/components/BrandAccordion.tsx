...
import { Brand, Model, AxiosInstance } from '../Interfaces';
...
const BrandAccordion: React.FC<BrandAccordionProps> = ({ brand, axiosInstance}) => {
    ...
    {isOpen && (
      <>
        ...
        {filteredModels.map(model => (
          <ModelDetails key={model.data.id} model={model} axiosInstance={axiosInstance} />
        ))}
      </>
    )}
    </div>
